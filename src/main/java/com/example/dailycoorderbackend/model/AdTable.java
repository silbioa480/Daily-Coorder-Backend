...
public class AdTable {
    ...
    public AdTable(long ad_id, String business_id, long ad_image, String ad_title, String ad_url, String ad_explain, boolean ad_is_prove, Date ad_register_date, int ad_expire) {
        this.ad_id = ad_id;
